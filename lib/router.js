...
// gyk-notes blog
router.get('/github/gyk-notes', lazyloadRouteHandler('./routes/github/gyk-notes/index.js'));

// 成都保障性租借租房公示公告
router.get('/cdzjryb/zw/hsweb_portal', lazyloadRouteHandler('./routes/cdzjryb/zw/hsweb_portal.js'));
